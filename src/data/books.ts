...
export const books: Book[] = [
  {
    ...
    category: "Roman",
    description: "Un roman captivant rempli de secrets, de tension et de rebondissements.",
    featured: true,
    variants: ['Format papier', 'Format numérique'],
  },

  {
    ...
    description: "Un livre essentiel pour mieux comprendre notre rapport à l'argent.",
    featured: true,
    variants: ['Format papier', 'Format audio'],
  },
...

  {
    ...
    category: "Relation",
    description: "Un livre autour des émotions, du silence et des relations humaines.",
    featured: true,
    variants: ['Format papier'],
  },
];
